...
insert  into `t_log_operation`(`uuid`,`operate_db`,`operate_dt`,`operate_type`,`operate_primarykey`,`operate_content`,`operate_person`,`operate_datetime`,`log_type`,`appkey`,`token`,`remarks`) values 
('205de587-21e5-4c0a-bb58-067e446bdc1c','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据','admin','2020-01-01 13:36:40','数据同步','yutu_web','zbcCloud-F3C00FE8D624DBB8AA7443BF86E4733B',NULL),
('28e90b17-c1ab-4e74-9e1f-e6be4d859dcb','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据success','admin','2020-01-01 18:14:34','数据同步','yutu_web','zbcCloud-8F645A0381C8971B7A4959FEA9C60999',NULL),
('46aec451-31b4-4e31-b8ec-cde7655fd1bb','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据','admin','2020-01-01 13:35:41','数据同步','yutu_web','zbcCloud-F3C00FE8D624DBB8AA7443BF86E4733B',NULL),
('6664d6f3-902b-4be6-9d6c-65064fb7ec36','yutuCloud','t_sys_organization','update',NULL,'yutu_web子系统同步数据success','admin','2020-01-01 18:29:59','数据同步','yutu_web','zbcCloud-F2A3F46DB1490D61B27620E3974B4466',NULL),
('6a9cc53b-9af4-484e-b66d-72f2a13b6ad3','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据success','admin','2020-01-01 18:27:15','数据同步','yutu_web','zbcCloud-09804FDA98F65BE17A87BF8982950339',NULL),
('869b8720-59fa-4eee-a0d1-b5e34ddf21c8','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据success','admin','2020-01-01 18:18:14','数据同步','yutu_web','zbcCloud-162DEB7F7D72CA3DED5BD67513ABBA08',NULL),
('882bb553-c056-4959-abd3-6a21d851bdf6','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据success','admin','2020-01-01 18:14:33','数据同步','yutu_web','zbcCloud-8F645A0381C8971B7A4959FEA9C60999',NULL),
('a402b1fb-2436-424e-9e9e-5679f56dce72','yutuCloud','t_sys_user','update',NULL,'yutu_web子系统同步数据success','admin','2020-01-01 18:18:21','数据同步','yutu_web','zbcCloud-162DEB7F7D72CA3DED5BD67513ABBA08',NULL);
