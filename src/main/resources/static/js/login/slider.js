(function (t, i, s, e) {
    var l = function (i, s) {
        this.ele = i;
        this.defaults = {
            width: $(window).width() < 1900 ? 273 :382,//根据分辨率适配滑块宽高
            height: $(window).width() < 1900 ? 34 :42,
            sliderBg: "rgba(0,0,0,0)",
            color: "#fff",
            fontSize: $(window).width() < 1900 ? 12 :14,//根据分辨率适配滑块字体
            bgColor: "rgba(0,204,255,.6)",
    ...
    l.prototype = {
        ...
        render: function () {
            var t = '<div class="ui-slider-wrap" style="border: 1px solid #02CDFB">' + '<div class="ui-slider-text ui-slider-no-select">' +
                this.opts.textMsg + "</div>" + '<div class="ui-slider-btn init ui-slider-no-select"></div>' +
