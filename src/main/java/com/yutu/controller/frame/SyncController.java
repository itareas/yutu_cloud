...
import com.yutu.mapper.frame.TCodConfigMapper;
import com.yutu.service.frame.IPowerService;
import com.yutu.utils.client.RestClientUtils;
...
public class SyncController {
    @Resource
    private IPowerService authorityManagerService;
    @Resource
        ...
        if (msgPack.getStatus() == 1) {
            ...
            if (listCinfig.size() > 0) {
                ...
                for (TSysUser tSysUser : listSysUser) {
                    ...
                    iPowerService.insertOperationLog(operation);
                }
            }
        }
        return msgPack;
